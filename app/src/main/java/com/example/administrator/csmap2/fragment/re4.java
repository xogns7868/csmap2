...
public class re4 extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter.addItem(ContextCompat.getDrawable(this,R.drawable.locate_icon),"서울특별시 성북구 정릉동 891-3");
        adapter.addItem(ContextCompat.getDrawable(this,R.drawable.phone_icon),"010-4194-0825");
        ...
        ImageButton.OnClickListener onClickListener = new ImageButton.OnClickListener() {
            ...
            public void onClick(View view) {
                Dialog dialog = new Dialog(re4.this);
                dialog.setContentView(R.layout.activity_fullimage);
                ImageView iv = (ImageView) dialog.findViewById(R.id.image);
                switch(view.getId()){
                    case R.id.image1 :
                        Glide.with(re4.this).load(R.drawable.yang1).into(iv);
                        break;
                    case R.id.image2:
                        Glide.with(re4.this).load(R.drawable.yang2).into(iv);
                        break;
                    case R.id.image3:
                        Glide.with(re4.this).load(R.drawable.yang3).into(iv);
                        break;
                    case R.id.image4:
                        Glide.with(re4.this).load(R.drawable.yang4).into(iv);
                        break;
                }
                dialog.show();
            }
        ...
        Glide.with(this).load(R.drawable.yang1).into(button1);
        button1.setOnClickListener(onClickListener);
        ImageButton button2 = (ImageButton)findViewById(R.id.image2);
        Glide.with(this).load(R.drawable.yang2).into(button2);
        button2.setOnClickListener(onClickListener);
        ImageButton button3 = (ImageButton)findViewById(R.id.image3);
        Glide.with(this).load(R.drawable.yang3).into(button3);
        button3.setOnClickListener(onClickListener);
        ImageButton button4 = (ImageButton)findViewById(R.id.image4);
        Glide.with(this).load(R.drawable.yang4).into(button4);
