...
import com.example.administrator.csmap2.fragment.re10;
...
public class caffe1  extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter.addItem(ContextCompat.getDrawable(this,R.drawable.locate_icon),"과학관");
        ...
        adapter2.addItem("카페 카라멜로");
        adapter2.addItem("카페 카라멜 마끼야토");
        adapter2.addItem("핫초콜릿");
        adapter2.addItem("티 (녹차/홍차/허브티)");
        adapter4.addItem("                 1200원 ");
        ...
        ImageButton.OnClickListener onClickListener = new ImageButton.OnClickListener() {
            ...
            public void onClick(View view) {
                Dialog dialog = new Dialog(caffe1.this);
                dialog.setContentView(R.layout.activity_fullimage);
                ImageView iv = (ImageView) dialog.findViewById(R.id.image);
                switch(view.getId()){
                    case R.id.image1 :
                        Glide.with(caffe1.this).load(R.drawable.cuf1).into(iv);
                        break;
                    case R.id.image2:
                        Glide.with(caffe1.this).load(R.drawable.cuf2).into(iv);
                        break;
                    case R.id.image3:
                        Glide.with(caffe1.this).load(R.drawable.d1).into(iv);
                        break;
                    case R.id.image4:
                        Glide.with(caffe1.this).load(R.drawable.d2).into(iv);
                        break;
                }
                dialog.show();
            }
        ...
        chat_send.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v){
                ...
                databaseReference.child("grazia").push().setValue(chat);
                chat_edit.setText("");
            }
        });
        ...
        databaseReference.child("grazia").addChildEventListener(new ChildEventListener() {  // message는 child의 이벤트를 수신합니다.
