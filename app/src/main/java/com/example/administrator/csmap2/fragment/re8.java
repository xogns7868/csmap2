...
public class re8 extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter.addItem(ContextCompat.getDrawable(this,R.drawable.locate_icon),"서울특별시 성북구 정릉동 966-1");
        adapter.addItem(ContextCompat.getDrawable(this,R.drawable.phone_icon),"02-919-4228");
        adapter.addItem(ContextCompat.getDrawable(this,R.drawable.clock_icon),"매일 10:30 - 21:00 연중무휴");
        adapter2.addItem("제육덮밥");
        adapter2.addItem("두루치기덮밥");
        adapter4.addItem("                 6000원 ");
        adapter4.addItem("                 6500원 ");
        adapter2.addItem("치즈순두부");
        ...
        adapter2.addItem("낙지볶음");
        adapter2.addItem("모듬볶음");
        adapter2.addItem("김치두루치기");
        adapter4.addItem("               10000원 ");
        adapter4.addItem("               15000원 ");
        adapter4.addItem("               13000원 ");
        adapter4.addItem("               10000원 ");
        adapter2.addItem("계란말이");
        adapter2.addItem("치즈계란말이");
        adapter2.addItem("해물파전");
        adapter2.addItem("닭도리탕");
        adapter2.addItem("뼈없는닭발");
        adapter2.addItem("오돌뼈");
        adapter4.addItem("               10000원 ");
        ...
        ImageButton.OnClickListener onClickListener = new ImageButton.OnClickListener() {
            ...
            public void onClick(View view) {
                Dialog dialog = new Dialog(re8.this);
                dialog.setContentView(R.layout.activity_fullimage);
                ImageView iv = (ImageView) dialog.findViewById(R.id.image);
                switch(view.getId()){
                    case R.id.image1 :
                        Glide.with(re8.this).load(R.drawable.song).into(iv);
                        break;
                    case R.id.image2:
                        Glide.with(re8.this).load(R.drawable.song2).into(iv);
                        break;
                    case R.id.image3:
                        Glide.with(re8.this).load(R.drawable.song3).into(iv);
                        break;
                    case R.id.image4:
                        Glide.with(re8.this).load(R.drawable.song4).into(iv);
                        break;
                }
                dialog.show();
            }
        ...
        chat_send.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v){
                ...
                databaseReference.child("송백").push().setValue(chat);
                chat_edit.setText("");
            }
        });
        ImageButton button1 = (ImageButton)findViewById(R.id.image1);
        Glide.with(this).load(R.drawable.song).into(button1);
        button1.setOnClickListener(onClickListener);
        ImageButton button2 = (ImageButton)findViewById(R.id.image2);
        Glide.with(this).load(R.drawable.song2).into(button2);
        button2.setOnClickListener(onClickListener);
        ImageButton button3 = (ImageButton)findViewById(R.id.image3);
        Glide.with(this).load(R.drawable.song3).into(button3);
        button3.setOnClickListener(onClickListener);
        ImageButton button4 = (ImageButton)findViewById(R.id.image4);
        Glide.with(this).load(R.drawable.song4).into(button4);
        button4.setOnClickListener(onClickListener);
        databaseReference.child("송백").addChildEventListener(new ChildEventListener() {  // message는 child의 이벤트를 수신합니다.
