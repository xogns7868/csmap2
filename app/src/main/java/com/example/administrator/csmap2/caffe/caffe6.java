...
public class caffe6  extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageButton.OnClickListener onClickListener = new ImageButton.OnClickListener() {
            ...
            public void onClick(View view) {
                Dialog dialog = new Dialog(caffe6.this);
                dialog.setContentView(R.layout.activity_fullimage);
                ImageView iv = (ImageView) dialog.findViewById(R.id.image);
                switch(view.getId()){
                    case R.id.image1 :
                        Glide.with(caffe6.this).load(R.drawable.cuf3).into(iv);
                        break;
                    case R.id.image2:
                        Glide.with(caffe6.this).load(R.drawable.cuf4).into(iv);
                        break;
                    case R.id.image3:
                        Glide.with(caffe6.this).load(R.drawable.d6).into(iv);
                        break;
                    case R.id.image4:
                        Glide.with(caffe6.this).load(R.drawable.d7).into(iv);
                        break;
                }
                dialog.show();
            }
        ...
        chat_send.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v){
                ...
                databaseReference.child("artrium").push().setValue(chat);
                chat_edit.setText("");
            }
        });
        ImageButton button1 = (ImageButton)findViewById(R.id.image1);
        Glide.with(this).load(R.drawable.cuf3).into(button1);
        button1.setOnClickListener(onClickListener);
        ImageButton button2 = (ImageButton)findViewById(R.id.image2);
        Glide.with(this).load(R.drawable.cuf4).into(button2);
        button2.setOnClickListener(onClickListener);
        ImageButton button3 = (ImageButton)findViewById(R.id.image3);
        Glide.with(this).load(R.drawable.d6).into(button3);
        button3.setOnClickListener(onClickListener);
        ImageButton button4 = (ImageButton)findViewById(R.id.image4);
        Glide.with(this).load(R.drawable.d7).into(button4);
        button4.setOnClickListener(onClickListener);
        databaseReference.child("artrium").addChildEventListener(new ChildEventListener() {  // message는 child의 이벤트를 수신합니다.
