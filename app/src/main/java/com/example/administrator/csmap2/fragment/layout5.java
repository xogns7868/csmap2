...
public class layout5 extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter2.addItem("짜장면");
        adapter2.addItem("간짜장");
        adapter2.addItem("짬뽕");
        adapter2.addItem("삼선짜장");
        adapter2.addItem("쟁반짜장");
        adapter2.addItem("볶음짬뽕");
        adapter2.addItem("삼선짬뽕");
        adapter2.addItem("볶음밥");
        adapter2.addItem("짜장밥");
        adapter2.addItem("짬뽕밥");
        adapter2.addItem("탕수육(소)");
        adapter4.addItem("                 4500원 ");
        ...
        ImageButton.OnClickListener onClickListener = new ImageButton.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                switch(view.getId()){
                    case R.id.image1 :
                        Glide.with(layout5.this).load(R.drawable.bukak_main).into(iv);
                        break;
                    case R.id.image2:
                        Glide.with(layout5.this).load(R.drawable.bukak2).into(iv);
                        break;
                    case R.id.image3:
                        Glide.with(layout5.this).load(R.drawable.bukak3).into(iv);
                        break;
                    case R.id.image4:
                        Glide.with(layout5.this).load(R.drawable.bukak4).into(iv);
                        break;
                }
                dialog.show();
            }
        ...
        Glide.with(this).load(R.drawable.bukak_main).into(button1);
        button1.setOnClickListener(onClickListener);
        ImageButton button2 = (ImageButton)findViewById(R.id.image2);
        Glide.with(this).load(R.drawable.bukak2).into(button2);
        button2.setOnClickListener(onClickListener);
        ImageButton button3 = (ImageButton)findViewById(R.id.image3);
        Glide.with(this).load(R.drawable.bukak3).into(button3);
        button3.setOnClickListener(onClickListener);
        ImageButton button4 = (ImageButton)findViewById(R.id.image4);
        Glide.with(this).load(R.drawable.bukak4).into(button4);
